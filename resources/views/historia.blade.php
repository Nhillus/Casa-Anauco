...
<!-- espacio en blanco -->
 ...
 <h2>El Arte Colonial en Venezuela</h2>
 <h3>
 <img src= {{asset ("imagenes/historia1.png")}} class="img-rounded" alt="Cinque Terre" width="400" height="400"> 
<br>
...
Desde fines del siglo antepasado, hubo personas que tomaron conciencia de la desaparición irremediable de ese legado y comenzaron a recoger objetos, cuadros, muebles, entre otros, con el fin de salvarlos de la destrucción. Aparecieron entonces los primeros coleccionistas de arte colonial venezolano, quienes se dieron a la tarea de rastrear por las casas de viejas familias, sacristías, casas de empeño y hasta camiones de basura, donde, por ejemplo, fueron encontradas cuatro sillas de las que sirvieron durante la firma del acta de Independencia. 
<br>
<img src= {{asset ("imagenes/historia2.png")}} class="img-rounded" alt="Cinque Terre" width="400" height="400"> 
<br>
...
Sin embargo, la pasión y hermandad que provino del refinamiento de los coleccionistas de las primeras décadas del siglo, hizo que se salvaran muchas de las obras maestras de aquel período colonial.
 ...
 <h2>
 <img src= {{asset ("imagenes/historia3.png")}} class="img-rounded" alt="Cinque Terre" width="400" height="400"> 
<br>
 Hitos y fechas:
 </h2>
 <br>
